<form class="flex flex-col gap-7" wire:submit="edit">
    ...
    <x-button-primary type="submit" wire:dirty.attr.remove="disabled" disabled>{{ __('Edit collection') }}</x-button-primary>
</form>
